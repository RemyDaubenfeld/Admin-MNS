        ...
        <div class="modal-container-mail">
            ...
            <div class="modal">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="edit_mail_user_details_submit">
                        <div class="check-update"><img src="assets/img/green-check-solid.svg" alt="Mettre à jour" class="update-user-check-img"></div>Mettre à jour
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-container-phone">
            ...
            <div class="modal">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="edit_phone_user_details_submit">
                        <div class="check-update"><img src="assets/img/green-check-solid.svg" alt="Mettre à jour" class="update-user-check-img"></div>Mettre à jour
                    </button>
                </form>
            </div>
        ...
        <div class="modal-container-location">
            ...
            <div class="modal">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="edit_location_user_details_submit">
                        <div class="check-update"><img src="assets/img/green-check-solid.svg" alt="Mettre à jour" class="update-user-check-img"></div>Mettre à jour
                    </button>
                </form>
            </div>
        ...
        <div class="modal-container-gender">
            ...
            <div class="modal">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="edit_gender_user_details_submit">
                        <div class="check-update"><img src="assets/img/green-check-solid.svg" alt="Mettre à jour" class="update-user-check-img"></div>Mettre à jour
                    </button>
                </form>
            </div>
        ...
        <div class="modal-container-name">
            ...
            <div class="modal">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="edit_name_user_details_submit">
                        <div class="check-update"><img src="assets/img/green-check-solid.svg" alt="Mettre à jour" class="update-user-check-img"></div>Mettre à jour
                    </button>
                </form>
            </div>
        ...
        <div class="modal-container-status">
            ...
            <div class="modal">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="edit_status_user_details_submit">
                        <div class="check-update"><img src="assets/img/green-check-solid.svg" alt="Mettre à jour" class="update-user-check-img"></div>Mettre à jour
                    </button>
                </form>
            </div>
        ...
        <div class="modal-container-archive">
            ...
            <div class="modal">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="archive_user_submit">
                        <div class="check-update"><img src="assets/img/green-check-solid.svg" alt="archiver" class="update-user-check-img"></div>Archiver
                    </button>
                </form>
            </div>
        </div>
